...
public class MainActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.listviewwithfooter).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.scrollview_listview:
                ...
                break;
            case R.id.listviewwithfooter:
                startActivity(new Intent(this, Activity_ListViewWithFooter.class));
                break;
        }
    }
}
